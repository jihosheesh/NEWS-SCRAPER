...
window.NEWS_DB = [
  {
    ...
    "summary": [
      "딥엑스·리벨리온, 엔비디아 맞서 AI 반도체 '생태계 전쟁' 나선다 ER 이코노믹리뷰."
    ],
    "chips": [
      "#AI",
      "#반도체",
  ...
  },
  {
    ...
    "summary": [
      "[서울=뉴시스]이재훈 기자 = 별 가득 반짝이는 우주를 연상케 하는 파란 청춘이 응축된 오프닝.",
      "그룹 '투어스'(TWS)가 28일 오후 서울 송파구 올림픽공원 케이스포돔(KSPO DOME)에 연 '2026 투어스 투어 '24/7:포:유' 인 서울(TWS TOUR ‘24/7:FOR:YOU' IN SEOUL)'은 체급을 키운 이들은 그 자체로 멈추지 않는 '보이후드 팝'의 증명이었다 청춘은 시치미를 떼거나 감정을 모른 척하지 않는다."
    ],
    "chips": [
      "#뉴스"
    ]
  },
  {
    ...
    "summary": [
      "[서울=뉴시스] 박현주 미술전문 기자 = 백남준을 유럽 미술계에 소개하고 비디오아트를 현대미술의 주요 장르로 끌어올린 독일 미술사학자이자 큐레이터 울프 헤르초겐라트(Wulf Herzogenrath)가 별세했다.",
  ...
  },
  {
    ...
    "summary": [
      "(파리=연합뉴스) 송진원 특파원 = 살인적인 폭염이 이어진 유럽에서 평년보다 초과 사망자가 1천300명 이상 나왔다고 세계보건기구(WHO)가 밝..."
    ],
    "chips": [
      "#의료"
    ]
  ...
  },
  {
    ...
    "summary": [
      "(서울·도쿄=연합뉴스) 김철선 기자 조성미 특파원 = 한일 국방장관이 28일 서울에서 만나 양국 공군 간 특수비행팀 교류협력, 해군 수색구조훈련..."
    ],
    "chips": [
      "#뉴스"
    ]
  ...
  },
  {
    ...
    "summary": [
      "(이스탄불=연합뉴스) 김동호 특파원 = 사우디아라비아 국영 석유회사 아람코가 운용하는 헬리콥터가 추락해 탑승자 전원이 사망했다고 사우디 국영 S..."
    ],
    "chips": [
      "#뉴스"
    ]
  ...
  },
  {
    ...
    "summary": [
      "고유가 지원금 6조800억 지급 완료…다음달 3일 신청 최종 마감."
    ],
    "chips": [
      "#뉴스"
    ]
  },
  {
    ...
    "summary": [
      "국내 중고거래 플랫폼을 중심으로 개인 간 거래 시장이 급성장하면서 분쟁도 함께 늘어나고 있다.",
      "하지만 현행 법체계상 개인 간 거래는 보호 제도의 적용을 받지 못하며 피해 구제가 쉽지 않은 상황이다.",
      "이에 플랫폼 사업자와 분쟁조정기관이 협력해 새로운 분쟁 해결 모델을 구축하고 있어 주목된다."
    ],
    "chips": [
      "#뉴스"
    ]
