...
window.NEWS_DB = [
  {
    ...
    "summary": [
      "메모리 품귀에… 美 엔비디아도 항복, AI 서버값 15% 올린다 조선일보."
    ],
    "chips": [
      "#AI",
      "#엔비디아"
  ...
  },
  {
    ...
    "summary": [
      "엔비디아, 고객사에 AI 서버 가격 15% 인상 예고 전자신문."
    ],
    "chips": [
      "#AI",
      "#엔비디아"
  ...
  },
  {
    ...
    "summary": [
      "프로야구 LG 트윈스가 한화 이글스를 완파하고 나흘 만에 3위를 탈환했다.LG는 23일 대전 한화생명볼파크에서 열린 2026 신한SOL KBO리그 원정 경기에서 한화에 12-3으로 크게 이겼다.2연패에서 벗어나 61승1무50패를 기록한 LG는 이날 키움 히어로즈에 덜미를 잡힌 KIA 타이거즈(60승2무50패)를 따돌리고 3위로 도약했다.문정빈과 송찬의가 나란히 3점 홈런을 터뜨려 승리를 이끌었고, 오스틴 딘은 타점 2개를 추가해 2년 만에 시즌."
    ],
    "chips": [
      "#KBO"
    ]
  },
  {
    ...
    "summary": [
      "그룹 룰라 출신 고영욱이 장도연을 비판했다.23일 고영욱은 소셜미디어에 “TV를 돌리다 보면 여기도 장도연, 저기도 장도연”이라고 했다.이어 “내가 기억하는 건 예전에 ‘개그콘서트’에서 어울리지도 웃기지도 않은데 경박하게 춤추던 모습밖에”라고 했다.",
      "그러면서 “이렇게 MC가 없나”라고 했다.고영욱은 최근 소셜미디어를 통해 연예계 인물과 각종 이슈에 대한 의견을 잇달아 내놓고 있다.[서울=뉴시스]."
    ],
    "chips": [
      "#뉴스"
    ]
  },
  {
    ...
    "summary": [
      "K리그2 선두 경쟁 중인 서울이랜드FC가 안방에서 파주 프런티어를 상대로 승리를 챙기는 데 실패했다.서울이랜드는 23일 목동종합운동장에서 열린 하나은행 K리그2 2026 23라운드에서 파주와 1-1로 비겼다.서울 이랜드는 최근 6경기 연속 무패(3승 3무) 행진을 이어가며 12승 5무 5패(승점 41)로 2위를 마크했다.",
      "하지만 선두 수원 삼성(승점 33)과 승점 차가 3으로 벌어졌다.파주는 7승 4무 11패(승점 25)로 11위에 자리했다.전."
    ],
    "chips": [
      "#뉴스"
    ]
  },
  {
    ...
    "summary": [
      "(샌프란시스코=연합뉴스) 권영전 특파원 = 주(州)별 인공지능(AI) 규제에 반대하는 쪽에 서 있었던 챗GPT 개발사 오픈AI가 미국 캘리포니아..."
    ],
    "chips": [
      "#AI",
      "#정책"
  ...
  },
  {
    ...
    "summary": [
      "중국 허베이성 장자커우(張家口)에서 배추 신선도를 유지하기 위해 발암물질인 포름알데히드를 사용한 사실이 적발돼 충격을 주고 있다.홍콩01과 중국상보(中國商報), 중앙통신은 23일 장자커우시 캉바오(康保)현에서 일부 업자가 포름알데히드 용액을 뿌려 배추를 보존 처리한 뒤 다른 지역으로 운송하려다가 들통이 났다고 보도했다.현지 당국은 해당 사실을 확인하고 관련자와 차량에 강제 조치를 취하는 한편 포름알데히드를 쓴 배추가 어디로 유통됐는지 긴급 추적."
    ],
    "chips": [
      "#뉴스"
    ]
  },
  {
    ...
    "summary": [
      ...
      "연구 대상은 2016년 기준 65~84세로, 조사 시작 당시에는 모두 장기요양이 필요하지 않은 상태였다."
    ],
    "chips": [
      "#의료",
      "#환경"
  ...
  },
  {
    ...
    "summary": [
      "(워싱턴=연합뉴스) 박성민 특파원 = 도널드 트럼프 미국 대통령의 몸무게가 지난 2024년 미 대선 전보다 급격히 불어났으며, 의료 전문가들은 ..."
    ],
    "chips": [
      "#정치",
      "#의료"
  ...
  },
  {
    ...
    "summary": [
      "(뉴욕=연합뉴스) 김연숙 특파원 = 미국 연방준비제도(Fed·연준) 내 대표적 매파 인사인 닐 카시카리 미국 미니애폴리스 연방은행 총재는 23일..."
    ],
    "chips": [
      "#금리"
    ]
