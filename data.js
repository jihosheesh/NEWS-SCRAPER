...
window.NEWS_DB = [
  ...
  },
  {
    ...
    "summary": [
      "“엔비디아 의존 끝낸다”…메타, 9월 자체 AI 칩 양산 돌입 서울경제TV."
    ],
    "chips": [
      "#AI",
      "#엔비디아"
  ...
  },
  {
    ...
    "summary": [
      "삼성 파운드리, 3년 만에 월간 흑자 기록…동력은 내부 HBM 물량 글로벌이코노믹."
    ],
    "chips": [
      "#반도체"
    ]
  ...
  },
  {
    ...
    "summary": [
      "중국 AI 칩 '脫엔비디아'…화웨이, 엔비디아 제쳤다 연합뉴스."
    ],
    "chips": [
      "#AI",
      "#엔비디아"
  ...
  },
  {
    ...
    "source": "테크M",
    "time": "방금 전",
    "url": "https://www.techm.kr/news/articleView.html?idxno=153312",
    "title": "[e스포츠人] \"복수 성공, 오늘 밤은 두 다리 뻗고 잘 것\"...'첫 MSI 우승' 한화생명 선수들의 소회",
    "summary": [
      "한화생명e스포츠가 중국의 강호 빌리빌리 게이밍(BLG)을 꺾고 창단 이래 처음으로 미드 시즌 인비테이셔널(MSI) 정상에 올랐습니다.",
      "지금까지 한화생명이라는 이름을 달고 국제대회에서 제대로 된 성적을 내지 못했었기 때문에 한화생명은 어느 때보다 행복한 모습이었습니다.리그오브레전드 월드 챔피언십(롤드컵) 쓰리핏이라는 대기록을 가지고 있지만, 정작 MSI 우승 트로피는 처음 들어 올린 '구마유시' 이민형은 벅찬 감정을 숨기지 않았습니다."
    ],
    "chips": [
      "#뉴스"
    ]
  },
  {
    ...
    "summary": [
      "한화생명e스포츠가 중국의 강호 빌리빌리 게이밍(BLG)을 꺾고 창단 이래 처음으로 미드 시즌 인비테이셔널(MSI) 정상에 올랐습니다.한화생명은 12일 대전컨벤션센터에서 펼쳐진 2026 MSI 결승전에서 '제우스' 최우제의 맹활약으로 BLG를 '승패패승승'으로 제압, 우승컵을 들어 올렸습니다.",
      "벼랑 끝에서 살려낸 불꽃...패자조 결승서 보여준 파괴전차의 집념결승전으로 가는 마지막 길목은 그야말로 험난한 가시밭길이었습니다."
    ],
    "chips": [
      "#뉴스"
    ]
  ...
  },
  {
    ...
    "summary": [
      "7일 경북 포항시 북구 영일만산업단지 내 포스코퓨처엠의 실리콘 음극재 데모플랜트(시제품 공장).",
      "제품 창고에 들어선 연구원이 비밀번호를 누르고 대형 금고처럼 생긴 항습 샘플 보관함을 열었다.",
      "안에는 고운 진회색 가루가 수십 mL 크기의 유리병에 담겨 여럿 진열돼 있었다."
    ],
    "chips": [
      "#전기차"
    ]
  },
  {
    ...
    "summary": [
      "한국 기업들의 올해 하계 휴가 일수는 평균 3.8일인 것으로 조사됐다.",
      "기업별로는 대기업이 5일 이상, 중소기업은 3일 휴가가 일반적이어서 기업 규모에 따른 격차가 나타났다.",
      "12일 한국경영자총협회가 전국 5인 이상 사업장 674개사를 대상으로 실시한 ‘2026년 하계 휴가 실태 및 경기전망 조사’에 따르면 응답 기업의 88.6%는 올해 하계 휴가를 실시한다고 답했다."
    ],
    "chips": [
      "#뉴스"
    ]
  },
  {
    ...
    "summary": [
      "두 달간 1500원을 웃돌던 원-달러 환율이 1400원대로 내려오자 낮은 가격에 달러를 사두려는 수요가 몰리면서 달려예금 잔액이 9조 원가량 늘었다.",
      "12일 금융권에 따르면 5대 은행(KB국민·신한·하나·우리·NH농협은행)의 달러예금 잔액은 9일 기준 709억400만 달러로 집계됐다.",
  ...
  },
  {
    ...
    "summary": [
      "지난해 전국 주택분 종합부동산세의 약 3분의 1을 서울 강남·서초·송파구 등 ‘강남 3구’가 부담한 것으로 나타났다.",
      "서울 성동구와 경기 성남·용인시 등의 종부세 납부액 증가세도 두드러졌다.",
      "12일 국세청 국세통계포털에 따르면 지난해 전국 주택분 종부세 결정세액은 1조3089억 원으로 집계됐다."
    ],
    "chips": [
      "#부동산"
    ]
  },
  {
    ...
    "summary": [
      "유해란, 연장 접전 끝 우승…2회 연속 LPGA '메이저 퀸'."
    ],
    "chips": [
      "#뉴스"
    ]
