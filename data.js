...
window.NEWS_DB = [
  ...
  },
  {
    ...
    "summary": [
      ...
      "보도에 따르면 도스 산토스와 콜린 커플은 프랑스 파리에서 열린 UNFP 시상식에 나란히 검은색 의상을 맞춰 입고 등장했다."
    ],
    "chips": [
      "#뉴스"
    ]
  },
  {
    ...
    "summary": [
      "끔찍한 다리 골절 부상으로 옥타곤을 떠났던 격투기 역사상 최고의 악동이 마침내 복귀를 눈앞에 뒀다.",
      "단 두 번의 챔피언 등극으로 천문학적인 재산을 모았던 코너 맥그리거(37)가 5년 만의 복귀를 정조준한다.",
  ...
  },
  {
    ...
    "summary": [
      "이재용 삼성전자 회장이 7년 만에 대국민 사과에 나섰다.",
      "삼성전자 노동조합 파업을 둘러싼 갈등 때문이다.",
      "삼성그룹 초기업노동조합 삼성전자 지부(초기업노조)는 오는 21일부터 6월7일까지 파업 예정이다."
    ],
    "chips": [
      "#삼성전자"
